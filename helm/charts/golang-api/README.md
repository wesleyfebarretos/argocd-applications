...
| tolerations | list | `[]` |  |
| volumeMounts[0].mountPath | string | `"/var/run/secrets/rustfs"` |  |
| volumeMounts[0].name | string | `"rustfs-oidc-token"` |  |
| volumeMounts[0].readOnly | bool | `true` |  |
| volumes[0].name | string | `"rustfs-oidc-token"` |  |
| volumes[0].projected.sources[0].serviceAccountToken.audience | string | `"rustfs"` |  |
| volumes[0].projected.sources[0].serviceAccountToken.expirationSeconds | int | `7200` |  |
